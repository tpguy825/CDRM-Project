...
export async function readTextFromClipboard() {
	try {
		...
		const result = parsePasted(clipboardText);

		// Output the result
		document.getElementById("licurl").value = result.licurl;
		document.getElementById("headers").value = result.headers;
		document.getElementById("pssh").value = result.pssh;
